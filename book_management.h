...
typedef struct _Book {
        ...
        char *bookfile;//used to record the bookfile this book belongs to
...
//inset the book list in txt file to the chain list
...
//create a new book list named by the librarian
int create_library(Book *bh, FILE *file);

//list all the book list
