...
User_management.o: User_management.c User_management.h utility.h
	gcc -c $<
User.o: User.c utility.h book_management.h User_management.h borrow_management.h search.h librarian.h User.h
	gcc -c $<
...
search.o: search.c utility.h book_management.h search.h librarian.h
	gcc -c $<
borrow_management.o: borrow_management.c utility.h book_management.h User_management.h search.h librarian.h User.h borrow_management.h
	gcc -c $<
clean:
	rm -rf *.o main
